  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] md:hidden">
        <div className="pointer-events-auto mx-auto flex max-w-lg items-center justify-between gap-3 rounded-2xl border border-[color-mix(in_srgb,var(--nm-fg)_12%,transparent)] bg-[var(--nm-bg-canvas)]/95 px-4 py-3 shadow-[0_-8px_32px_rgba(26,26,26,0.12)] backdrop-blur-md">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex shrink-0 items-center justify-center rounded-full bg-[var(--nm-inverse)] px-4 py-2.5 text-sm font-semibold text-[var(--nm-inverse-fg)]"
          >
            פגישה במקום
          </a>
        </div>
