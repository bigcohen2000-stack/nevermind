...
export const glossaryConcepts: GlossaryConcept[] = [
  ...
  },
  {
    slug: "real-nothing",
    title: "כלום אמיתי",
    summary: "הנקודה שבה המוח מפסיק להלביש צורה על הריק, ורואה שכל ניסיון להגדיר כלום כבר יוצר יש.",
    definition:
      'כלום אמיתי אינו חלל שחור, ריק לבן, או מרחב בלי חפצים. אלה כבר צורות. כלום אמיתי הוא היעדר מוחלט של גבול, ולכן המוח לא יכול לדמיין אותו בלי להרוס אותו מיד.',
    whyItMatters:
      "כשלא מבינים מהו כלום, מפחדים מהמוות, מהריק ומהיעלמות כאילו הם מפלצת חיצונית. הבנה לוגית של המושג הזה מפרקת את האיום, כי היא מראה שאין אני נפרד שיכול לעמוד מול האין.",
    dailyExample:
      'כשאתה מנסה "לדמיין כלום", מופיע אצלך מיד משהו: חושך, חלל, שקט, ריחוף. זה בדיוק הרגע שבו רואים שהמוח לא מחזיק כלום, אלא רק עוד יש בתחפושת.',
    tags: ["כלום אמיתי", "שאלות גדולות", "בהירות"],
    keywords: ["כלום", "כלום אמיתי", "אין", "אינסוף", "הכל", "מוות", "ריק"],
    oppositeLink: {
      href: "/glossary/reality/",
      title: "הצד השני: המציאות",
      description: "אם כלום אמיתי מפרק כל צורה, המציאות היא המקום שבו צורה כבר נתפסת ומקבלת גבול.",
    },
    relatedConceptSlugs: ["reality", "self", "clarity"],
    relatedLinks: [
      {
        href: "/topics/real-nothing/",
        title: "נושא: כלום אמיתי",
        description: "מאמרים ופירוקים סביב כלום, אין, גבול, מוות והקשר שלהם לשקט נפשי.",
      },
      {
        href: "/glossary/reality/",
        title: "מושג יסוד: המציאות",
        description: "כדי להבין כלום, צריך להבין גם מה קורה ברגע שבו צורה כבר מופיעה ונחווית כמציאות.",
      },
    ],
  },
  {
