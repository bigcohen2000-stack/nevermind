...
import { i as getDefaultExportFromCjs, j as renderJSX, k as createVNode, A as AstroJSX, l as AstroUserError } from './astro/server_CTXZP3YY.mjs';
...
const te = /*@__PURE__*/getDefaultExportFromCjs(reactExports);
...
async function check$1(Component, props, children) {
  ...
  if (Component.prototype != null && typeof Component.prototype.render === "function") {
    return te.Component.isPrototypeOf(Component) || te.PureComponent.isPrototypeOf(Component);
  }
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
  ...
  for (const [key, value] of Object.entries(slotted)) {
    ...
    slots[name] = te.createElement(static_html_default, {
  ...
  if (newChildren != null) {
    newProps.children = te.createElement(static_html_default, {
      hydrate: needsHydration(metadata),
      value: newChildren
    });
  }
  ...
  const vnode = te.createElement(Component, newProps);
  const renderOptions = {
